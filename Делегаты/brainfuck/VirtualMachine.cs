...
namespace func.brainfuck
{
	public class VirtualMachine : IVirtualMachine
	{
		...
		private Dictionary<char, Action<IVirtualMachine>> InstructionDict { get; set; } //Инициализируем поля в конструкторе 
		...
		{
			InstructionDict.Add(symbol, execute); //Добавляем в словарь название инструкции и ее тело используя анонимный делегат, переданный в метод в качестве аргумента
		}
